      ...
      {/* Login modal  */}
        <div className="modal fade" id="loginModal" tabIndex={-1} role="dialog" aria-labelledby="exampleModalCenterTitle" aria-hidden="true">
          <div className="modal-dialog modal-dialog-centered" role="document">
            <div className="modal-content text-center">              
              <form className="form-signin" action="/login" method="POST">  {/* Login FLASK  */}
                <img className="mb-2" src="../static/assets/images/login_logo.png" alt="Logo" width="150" height="150" />
                <h1 className="h3 mb-3 font-weight-normal">Please sign in</h1>
                <label htmlFor="inputEmail" className="sr-only">Email address</label>
                <input type="email" id="inputEmail" name="loginEmail" className="form-control" placeholder="Email address" required/>
       ...
       {/* Create account modal  */}
        <div className="modal fade" id="createAccount" tabIndex={-1} role="dialog" aria-labelledby="exampleModalCenterTitle" aria-hidden="true">
          <div className="modal-dialog modal-dialog-centered" role="document">
            <div className="modal-content text-center">
              <form className="form-signin" action="/registrate" method="post"> {/* Create account FLASK  */}
                <img className="mb-2" src="../static/assets/images/login_logo.png" alt="Logo" width={150} height={150} />
